...
namespace ClassEquipos
{
    public class AccesoBD
    {
        ...
        public AccesoBD()
        {
            string CadCon = (@"Data Source = GRM\SQLEXPRESS; Initial Catalog = MiTaller2021; Integrated Security = false;");
        ...
        public DataTable Login(string usu, string con)
        {
            ...
            try
            {
                ...
                sqlCm.Parameters.Add("@Cel", SqlDbType.VarChar).Value = con;
